...
Color veryLightGrey = const Color.fromARGB(255, 211, 213, 223);
Color darkgrey = const Color.fromARGB(255, 92, 94, 102);
Color dark = const Color(0xFF363740);
Color grey = const Color.fromARGB(255, 75, 77, 83);
Color active = const Color(0xFF3C19C0);
Color blue = const Color.fromARGB(255, 87, 51, 214);
...
Color mapBAckground = const Color.fromARGB(255, 130, 182, 96);
