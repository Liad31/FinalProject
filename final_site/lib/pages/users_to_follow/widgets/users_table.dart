  ...
  Future<String>? fetchData() async {
    Future<String> getNat() async {
      var response = await http
          .get(Uri.parse(
              'https://floating-harbor-96334.herokuapp.com/http://104.154.93.111:8080/topUsers?n=25&sort=nationalisticScore&days=30'))
          .then((value) {
    ...
    Future<String> getRel() async {
      var response = await http
          .get(Uri.parse(
              'https://floating-harbor-96334.herokuapp.com/http://104.154.93.111:8080/topUsers?n=25&sort=relevancyScore&days=30'))
          .then((value) {
        if (value.statusCode == 200) {
          var json =
              jsonDecode(value.body.toString()).cast<Map<String, dynamic>>();
